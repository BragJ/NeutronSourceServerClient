...
/* Generated from ../O.Common/neutrons.dbd */
...
epicsShareExtern dset *pvar_dset_devAoDemoNeutronDelay;
epicsShareExtern dset *pvar_dset_devAoDemoNeutronCount;
...
static const dset * const devsl[42] = {
    ...
    pvar_dset_devAoDemoNeutronDelay,
    pvar_dset_devAoDemoNeutronCount,
    pvar_dset_devBiSoft,
...
epicsShareExtern void (*pvar_func_startPVAClientRegister)(void);
epicsShareExtern void (*pvar_func_stopPVAClientRegister)(void);
epicsShareExtern void (*pvar_func_startPVAServerRegister)(void);
epicsShareExtern void (*pvar_func_stopPVAServerRegister)(void);
epicsShareExtern void (*pvar_func_registerChannelProviderLocal)(void);
epicsShareExtern void (*pvar_func_dbPvRegister)(void);
epicsShareExtern void (*pvar_func_neutronServerRegister)(void);
...
int neutrons_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/opt/egcs/epics/EPICS4/EPICSV4Sandbox/neutronsDemoServer";
    ...
    (*pvar_func_asSub)();
    (*pvar_func_startPVAClientRegister)();
    (*pvar_func_stopPVAClientRegister)();
    (*pvar_func_startPVAServerRegister)();
    (*pvar_func_stopPVAServerRegister)();
    (*pvar_func_registerChannelProviderLocal)();
    (*pvar_func_dbPvRegister)();
    (*pvar_func_neutronServerRegister)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"neutrons_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    neutrons_registerRecordDeviceDriver(*iocshPpdbbase);
}
